...
from imagebind.models.imagebind_model import ImageBindModel as ImageBindModelBase
...
class CustomImageBindModel(ImageBindModelBase):
    def __init__(
        self,
        video_frames=2,
        kernel_size=(2, 14, 14),
...
def custom_imagebind_huge(pretrained=False):
